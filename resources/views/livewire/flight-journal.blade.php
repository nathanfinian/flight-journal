<div>
    ...
    <div class="flex gap-4">
        ...
        <x-ui.navbar.item 
            ...
            :active="request()->is('flight-journal/actual')"
        />
    </div>
    ...
    <table class="border border-collapse min-w-full text-sm rounded-xl overflow-hidden mt-4 shadow-lg">
        ...
        <tbody class="divide-y divide-gray-100 dark:divide-neutral-800">
            @forelse($flights as $index => $flight)
                <tr class="hover:bg-gray-50 dark:hover:bg-neutral-800/60 cursor-pointer">
                    ...
                    <td class="px-4 py-3">
                        <x-ui.button color="indigo" variant="outline" size="xs" wire:click="openEdit({{ $flight->id }})">
                            Confirm Flight
                        </x-ui.button>
                    </td>
                </tr>
